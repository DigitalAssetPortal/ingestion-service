package com.accenture.ingestion.service.scaladsl
...
object RunOps {
  ...
  private[scaladsl] val elasticsearchContainer = new ElasticsearchContainer("docker.elastic.co/elasticsearch/elasticsearch-oss:6.4.3")
